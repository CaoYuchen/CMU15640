...
type RemoteTribServer interface {
	...
	GetFriends(args *GetFriendsArgs, reply *GetFriendsReply) error
	PostTribble(args *PostTribbleArgs, reply *PostTribbleReply) error
	DeleteTribble(args *DeleteTribbleArgs, reply *DeleteTribbleReply) error
	ModifyTribble(args *ModifyTribbleArgs, reply *ModifyTribbleReply) error
